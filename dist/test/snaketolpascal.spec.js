...
describe('Snake case to Lower Pascal case conversion', () => {
    let input = "sweet_child_of_mine";
    let result = ext_string_case_1.ExtStringCase.snakeToPascalCase(input, true);
    it('Should be Lower Pascal cased', () => {
